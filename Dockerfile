# OPAM for debian-unstable with local switch of OCaml 4.06.0+trunk+flambda
...
RUN mkdir .ssh && \
  ...
  sudo -u opam sh -c "opam init -a -y --comp 4.06.0+trunk+flambda /home/opam/opam-repository" && \
